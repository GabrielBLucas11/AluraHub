        ...
        <ScrollView>
            <View style={estilos.container}>
                ...
                <>
                    ...
                    <Text style={estilos.textoNome}>{usuario.name == null ? usuario.login : usuario.name}</Text>
                    { usuario.bio &&
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Repositorios', {name: usuario.login})}>
